            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="basic-example">
                        ...
                        <a href="{{route('sembako.edit',$data->id)}}" class="btbtn-small btn-warning">Edit</a>
                        <form action="{{route('sembako.destroy',$data->id)}}" method="POST" onsubmit="return confirm('Apakah yakin menghapusdata ini?')">
                            @csrf
                            @method('DELETE')
